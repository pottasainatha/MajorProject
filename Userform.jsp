...
<nav class="navbar navbar-expand-lg bg-body-tertiary">
  <div class="container-fluid">
   ...
   <input type="hidden" class="form-control" id="exampleFormControlInput5" value="${list.id}" placeholder="Enter Your Id" name="id" style="width:300px">
   </div>
   <div class="mb-3 container" align="center">
...
<div class="mb-3 container" align="center">
  ...
  <input type="email" class="form-control" id="exampleFormControlInput2" value="${list.email}" placeholder="Enter Your Email_Id" name="email" style="width:300px">
</div>
<div class="mb-3 container" align="center">
